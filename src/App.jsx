...
import AITransformationFlow from './pages/AITransformationFlow.jsx'
import PredictiveMaintenance from './pages/PredictiveMaintenance.jsx'
import OperationalFlowAudit from './pages/OperationalFlowAudit.jsx'
...
export default function App() {
  ...
  const pages = { dashboard: Dashboard, copilot: AICopilot, audit: AIAuditMonitor, flow: AITransformationFlow, predictive: PredictiveMaintenance, opflow: OperationalFlowAudit, caseanalysis: CaseAnalysis }
